<?php
/**
 * ACDM functions and definitions
 *
 * @package WordPress
...
function acdm_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		<article id="comment-<?php comment_ID(); ?>" class="comment acdm-comment-<?php echo $comment->comment_ID%8; ?>">
